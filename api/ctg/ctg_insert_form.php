...
try{
    ...
    log_audit_action($db, 'ADD_CTG_RESPONSE', $authenticated_user['id'], ($is_responsable ? 'responsable' : 'usuario'), 'respuesta_ctg', $db->lastInsertId(), ['ctg_id' => $ctgId, 'mensaje' => $mensaje, 'url_adjunto' => $urlAdjunto]);
