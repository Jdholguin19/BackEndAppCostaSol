...
class DB
{
    ...
    private const DB_NAME = 'portalao_BDU_Pruebas';             // p.ej. costasol_app
    private const DB_USER = 'portalao_jholguin';        // p.ej. portalao_gcoello
    private const DB_PASS = 'jofCTV321!*';       // p.ej. ********
