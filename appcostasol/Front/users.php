...
<div class="modal fade" id="modalUsuario" tabindex="-1">
  <div class="modal-dialog"><form class="modal-content" id="formUsuario">
    ...
    <div class="modal-body row g-2">
      ...
      <div class="col-4"><input required class="form-control" name="rol_id" id="rol_id" placeholder="Rol ID"></div>
      <div class="col-12"><input type="password" class="form-control" name="contrasena" id="contrasena" placeholder="Contraseña (solo al crear / cambiar)"></div>
    </div>
